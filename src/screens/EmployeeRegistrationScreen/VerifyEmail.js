      ...
      try {
        ...
        if (user) {
          ...
          if (user.emailVerified) {
            console.log('Email is verified, navigating to Home');
            setIsAuthenticated(true); // Set authenticated state
            navigation.navigate('Home'); // Navigate to home screen if email is verified
          } else {
          ...
          navigation.navigate('EmployeeLogin'); // Redirect to login if user not found
        }
      } catch (error) {
  ...
  const handleManualRefresh = async () => {
    try {
      ...
      if (user) {
        ...
        navigation.navigate('EmployeeLogin'); // Navigate to login screen if no user found
      }
    } catch (error) {
